...
for i in range(-5,40):
    file_name = f"large_mean_cv_energy_dis_no_cons_{i}_new_cv_trig.csv" #"large_mean_cv_energy_dis_{i}_new_cv.csv"
...
combined_df.to_csv("combined_large_mean_cv_energy_dis_trig.csv", index=False)
