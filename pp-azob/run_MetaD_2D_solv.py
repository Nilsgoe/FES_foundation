...
dyn = WT_Metadynamics(atoms, timestep=timestep, temperature_K=300, friction=.1, trajectory='metad_pp_azob_trans_2D_solv_cont_.traj',fixcm=False,
                   cvs=compute_dihedral_and_angle,std_dev=[5,5],bias_height=.1 ,interval_size=100,output_file='metad_pp_azob_trans_2D_solv.txt',input_file='metad_pp_azob_trans_2D_solv.txt',well_temp=True,bias_factor=10,wrapping=[True,True],bounds=((-180,180),(0,180)),max_bias=int(1e6))
dyn.run(7e5)
