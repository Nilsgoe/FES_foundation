...
#SBATCH --array=0-20%1
#SBATCH -o /nexus/posix0/FHI-Theory/ngoen/Enhanced_sampling/MACE/malonaldehyd/logs/umd_cueq_%x_%A_%a.out
#SBATCH -e /nexus/posix0/FHI-Theory/ngoen/Enhanced_sampling/MACE/malonaldehyd/logs/umd_cueq_%x_%A_%a.err
