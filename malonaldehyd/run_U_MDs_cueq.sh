...
#SBATCH --array=0-20%1
#SBATCH -o ./logs/umd_cueq_%x_%A_%a.out
#SBATCH -e ./logs/umd_cueq_%x_%A_%a.err
...
cp "logs/umd_cueq_${SLURM_JOB_NAME}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out" "${project_dir}/logs/" 2>/dev/null || true
cp "logs/umd_cueq_${SLURM_JOB_NAME}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.err" "${project_dir}/logs/" 2>/dev/null || true
